...
CubeComponent::CubeComponent(float size)
{
	...
	//Top tonen
	verts.push_back(Vertex::PCTN(p + glm::vec3(-s.x, s.y + 0.2, -s.z), color, glm::vec2(0, 0), glm::vec3(0, 1, 0)));
	verts.push_back(Vertex::PCTN(p + glm::vec3(s.x, s.y + 0.2, -s.z), color, glm::vec2(1, 0), glm::vec3(0, 1, 0)));
	verts.push_back(Vertex::PCTN(p + glm::vec3(s.x, s.y + 0.2, s.z), color, glm::vec2(1, 1), glm::vec3(0, 1, 0)));
	verts.push_back(Vertex::PCTN(p + glm::vec3(-s.x, s.y + 0.2, s.z), color, glm::vec2(0, 1), glm::vec3(0, 1, 0)));
